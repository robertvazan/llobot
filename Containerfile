...
# Setup bashrc to activate venv.
COPY --chown=${DEV_USER} scripts/activate.sh /home/${DEV_USER}/.local/bin/activate_project.sh
RUN echo 'source ~/.local/bin/activate_project.sh' >> ~/.bashrc
