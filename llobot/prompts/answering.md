...
- If tools are available and the user is just asking a question, use tools only to obtain information relevant to the user's question and refrain from making changes
